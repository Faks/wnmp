...
namespace Wnmp.Programs
{
    ...
    class MariaDB
    {
        ...
        private static string MariaDBStopEXE = Main.StartupPath + "/mariadb/MariaDBStop.exe";
        ...
        {
            startprocess(mysqldExe, "--defaults-file=mariadb/my.ini", false);
